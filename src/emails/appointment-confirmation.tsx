...
<head>
  ...
  <title>Agendamento confirmado — ${esc(data)} às ${esc(horario)}</title>
</head>
<body style="margin:0;padding:0;background-color:hsl(240,4.8%,95.9%);font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;">Agendamento confirmado — ${esc(data)} às ${esc(horario)}</div>
  <div style="margin:0 auto;padding:32px 20px;max-width:600px;background-color:hsl(0,0%,100%);border-radius:12px;">
    ...
    <div style="text-align:center;margin-bottom:8px;">
      <p style="display:inline-block;width:56px;height:56px;line-height:56px;background-color:#f0fdf4;color:#16a34a;border-radius:50%;font-size:28px;font-weight:bold;text-align:center;margin:0 auto;">✓</p>
    </div>

    <div style="text-align:center;margin-bottom:24px;">
      <p style="font-size:22px;font-weight:bold;color:hsl(240,10%,3.9%);margin:0 0 8px;">Agendamento confirmado!</p>
      <p style="font-size:15px;color:hsl(240,5%,64.9%);margin:0;">Olá, <strong>${esc(nome)}</strong>! Seu horário foi reservado com sucesso.</p>
    </div>
    ...
    <div style="text-align:center;">
      <p style="font-size:14px;color:hsl(240,5%,64.9%);margin-bottom:16px;line-height:1.6;"><strong>${esc(ownerName)}</strong> entrará em contato em breve para confirmar os detalhes. Se precisar alterar ou cancelar, responda diretamente a este e-mail.</p>
